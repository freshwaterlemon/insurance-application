...
export default async function PoliciesPage(props: {
	...
	const { policies, newOffset, totalPolicy } = await getPoliciesPaged(Number(offset), 5);
	...
	return <>
		<div className="p-4 pt-3">
			<Addbutton buttonName={`Add Policy`} linkpath={`policies/add`} />
			<PoliciesTable policies={policies} offset={newOffset} totalPolicy={totalPolicy} />
		</div>
	</>
}