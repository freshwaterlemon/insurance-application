            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">
                                {dashboardData.customersCount} customers in total
                            </p>
                        </CardContent>
                    </Card>
                </Link>
                ...
                <Link href="/policies">
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{dashboardData.policiesCount}</div>
                            <p className="text-xs text-muted-foreground">
                                {dashboardData.policiesCount} policies available in total
                            </p>
                        </CardContent>
                    </Card>
                </Link>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                <Card className="col-span-5">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Total earnings from each customer with 10% of base price as premium
                        </CardDescription>
                    </CardHeader>
